...
lr=0.01;
mem_size_per_class=0;
mem_samples=0;

if [ $2 = "mnist" ] || [ $2 = "svhn" ]; then
  if [ $3 = "iid" ]; then
    python main_supcon.py --criterion $1 --dataset $2 --model cnn --training_data_type iid  \
            --batch_size 256 --mem_samples $mem_samples --val_batch_size 128 --num_workers 8 --steps_per_batch_stream 20 --epochs 1 \
            --learning_rate_stream $lr --temp_cont 0.1 --mem_w_labels \
            --mem_size_per_class $mem_size_per_class --train_samples_per_cls 4096 --test_samples_per_cls 500 --knn_samples 1000 --trial $4
  fi
  ...
  if [ $3 = "seq-im" ]; then
    python main_supcon.py --criterion $1 --dataset $2 --model cnn --training_data_type class_iid \
        --batch_size 256 --mem_samples $mem_samples --val_batch_size 128 --num_workers 8 --steps_per_batch_stream 20 --epochs 1 \
        --learning_rate_stream $lr --temp_cont 0.1 --mem_w_labels \
        --mem_size_per_class $mem_size_per_class --train_samples_per_cls 2048 4096 2048 4096 2048 2048 4096 2048 2048 4096 \
...
if [ $2 = "cifar100" ] ; then
  if [ $3 = "iid" ]; then
    python main_supcon.py --criterion $1 --dataset $2 --model $model --training_data_type iid  \
      --batch_size 128 --mem_samples $mem_samples --val_batch_size 128 --num_workers 8 --steps_per_batch_stream 10 --print_freq 10 --epochs 1 \
      --learning_rate_stream $lr --temp_cont 0.1 --mem_w_labels \
      --mem_size_per_class $mem_size_per_class --train_samples_per_cls 2560 --test_samples_per_cls 250 --knn_samples 5000 --trial $4
  fi
  ...
  if [ $3 = "seq-im" ]; then
    python main_supcon.py --criterion $1 --dataset $2 --model $model --training_data_type class_iid \
      --batch_size 128 --mem_samples $mem_samples --val_batch_size 128 --num_workers 8 --steps_per_batch_stream 10 --print_freq 10 --epochs 1 \
      --learning_rate_stream $lr --temp_cont 0.1 --mem_w_labels \
      --mem_size_per_class $mem_size_per_class --train_samples_per_cls 1280 2560 2560 2560 1280 2560 2560 2560 2560 1280 2560 2560 2560 2560 1280 2560 2560 2560 2560 1280 \
...
if [ $2 = "tinyimagenet" ] ; then
  if [ $3 = "iid" ]; then
    python main_supcon.py --criterion $1 --dataset $2 --model $model --training_data_type iid  \
      --batch_size 128 --mem_samples $mem_samples --val_batch_size 64 --num_workers 8 --steps_per_batch_stream 10 --print_freq 10 --val_freq 4 --epochs 1 \
      --learning_rate_stream $lr --temp_cont 0.1 --mem_w_labels \
      --mem_size_per_class $mem_size_per_class --train_samples_per_cls 500 --test_samples_per_cls 50 --knn_samples_ratio 1.0 --trial $4
  fi
  ...
  if [ $3 = "seq-im" ]; then
    python main_supcon.py --criterion $1 --dataset $2 --model $model --training_data_type class_iid \
      --batch_size 128 --mem_samples $mem_samples --val_batch_size 64 --num_workers 8 --steps_per_batch_stream 10 --print_freq 10 --val_freq 4 --epochs 1 \
      --learning_rate_stream $lr --temp_cont 0.1 --mem_w_labels \
      --mem_size_per_class $mem_size_per_class \
